...
namespace happy_pet_game_2019
{
    ...
    public class Cat : Pet
    {
        ...
        #region Constructors
        public Cat(string inName, string inTrait, Image inIdle, Image inHurt, Image inDeath, Image inBasic, Image inSkill, Image inUlti, int inMaxHealth, int inMaxHappiness, int inEnergy, int inDefense) : base(inName,inTrait,inIdle,inHurt,inDeath,inBasic,inSkill,inUlti,inMaxHealth,inMaxHappiness,inEnergy, inDefense)
        {
            VaccStatus = false;
        }
        #endregion
