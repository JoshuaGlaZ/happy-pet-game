...
namespace happy_pet_game_2019
{
    ...
    public class Fish : Pet
    {
        ...
        #region Constructors
        public Fish(string inName, string inTrait, Image inPict, int inMaxHealth, int inMaxHappiness, int inEnergy, int inDefense) : base(inName, inTrait, inPict, inMaxHealth, inMaxHappiness, inEnergy, inDefense)
        {
            EnvStatus = "Normal";
        }
        #endregion
